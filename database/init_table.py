...
cursor.execute('INSERT IGNORE INTO Students VALUES ("student", 123, JSON_ARRAY(\'CMPE160\'));')
cursor.execute('INSERT IGNORE INTO Students VALUES ("senior", 234, JSON_ARRAY(\'CMPE250\'));')
